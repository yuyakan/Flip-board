    ...
    var body: some View {
        ...
        ZStack{
            VStack{
                Spacer()
                ZStack{
                    Image("brick2").rotationEffect(Angle.degrees(-90))
                ...
                Spacer()
                NavigationLink(destination: Brick2View(text: $text, textcolor: $textcolor, backcolor: $backcolor, selection: $selection)) {
