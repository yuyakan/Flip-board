...
struct Brack2SettingView: View {
    ...
    var body: some View {
        ...
        ZStack{
            VStack{
                ZStack{
                    Image("brackboard2").rotationEffect(Angle.degrees(-90))
                ...
                Spacer()
                NavigationLink(destination: Brack2View(text: $text, textcolor: $textcolor, backcolor: $backcolor, selection: $selection)) {
