    ...
    var body: some View {
        ...
        ZStack{
            VStack{
                Spacer()
                ZStack{
                    Image("brackboard").rotationEffect(Angle.degrees(-90))
                ...
                Spacer()
                NavigationLink(destination: BrackView(text: $text, textcolor: $textcolor, backcolor: $backcolor, selection: $selection)) {
