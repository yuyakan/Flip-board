...
struct SkySettingView: View {
    ...
    var body: some View {
        ...
        ZStack{
            VStack{
                ZStack{
                    Image("sky").rotationEffect(Angle.degrees(-90))
                ...
                Spacer()
                NavigationLink(destination: SkyView(text: $text, textcolor: $textcolor, backcolor: $backcolor, selection: $selection)) {
