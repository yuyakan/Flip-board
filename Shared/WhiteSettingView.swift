...
struct WhiteSettingView: View {
    ...
    var body: some View {
        ...
        ZStack{
            VStack{
                ZStack{
                    Image("whiteboard").rotationEffect(Angle.degrees(-90))
                ...
                Spacer()
                NavigationLink(destination: WhiteView(text: $text, textcolor: $textcolor, backcolor: $backcolor, selection: $selection)) {
